    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(32)  = dumData; %prealloc
                    ...
                    ;% simulink5ms_plotAndGains_P.error1_Gain
                    section.data(9).logicalSrcIdx = 16;
                    section.data(9).dtTransOffset = 8;

                    ;% simulink5ms_plotAndGains_P.error2_Gain
                    section.data(10).logicalSrcIdx = 17;
                    section.data(10).dtTransOffset = 9;

                    ;% simulink5ms_plotAndGains_P.error3_Gain
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(10)  = dumData; %prealloc
                    ...
                    ;% simulink5ms_plotAndGains_B.error1
                    ...
                    ;% simulink5ms_plotAndGains_B.error2
                    ...
                    ;% simulink5ms_plotAndGains_B.error3
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(12)  = dumData; %prealloc
                    ...
                    ;% simulink5ms_plotAndGains_DW.TAQSigLogging_InsertedFor_Sum1_at_outport_0_PWORK.AQHandles
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 1;

                    ;% simulink5ms_plotAndGains_DW.TAQSigLogging_InsertedFor_Sum2_at_outport_0_PWORK.AQHandles
                    section.data(3).logicalSrcIdx = 2;
                    section.data(3).dtTransOffset = 2;

                    ;% simulink5ms_plotAndGains_DW.TAQSigLogging_InsertedFor_Sum_at_outport_0_PWORK.AQHandles
                    section.data(4).logicalSrcIdx = 3;
                    section.data(4).dtTransOffset = 3;

                    ;% simulink5ms_plotAndGains_DW.TAQSigLogging_InsertedFor_error1_at_outport_0_PWORK.AQHandles
                    section.data(5).logicalSrcIdx = 4;
                    section.data(5).dtTransOffset = 4;

                    ;% simulink5ms_plotAndGains_DW.TAQSigLogging_InsertedFor_error2_at_outport_0_PWORK.AQHandles
                    section.data(6).logicalSrcIdx = 5;
                    section.data(6).dtTransOffset = 5;

                    ;% simulink5ms_plotAndGains_DW.TAQSigLogging_InsertedFor_error3_at_outport_0_PWORK.AQHandles
                    section.data(7).logicalSrcIdx = 6;
                    section.data(7).dtTransOffset = 6;
    ...
    targMap.checksum0 = 434034222;
    targMap.checksum1 = 3898556901;
    targMap.checksum2 = 497223002;
    targMap.checksum3 = 2477995020;
